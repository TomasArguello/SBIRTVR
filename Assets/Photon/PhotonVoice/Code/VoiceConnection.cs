...
namespace Photon.Voice.Unity
{
    ...
    public class VoiceConnection : ConnectionHandler, ILoggable
    {
        ...
        public bool GetRecordingState {
            get {
                return this.primaryRecorder.VoiceDetector.Detected;
            }
        }
        ...
        protected override void Awake()
        {
            ...
            //debugLogText = GameObject.Find("DebugLogText").GetComponent<Text>();
        }
        ...
        protected virtual void Update()
        {
            ...
            string text = "";
            text += "VoiceDetector.On:" + this.primaryRecorder.VoiceDetector.On + "\n";
            text += "Threshold       :" + this.primaryRecorder.VoiceDetector.Threshold + "\n";
            text += "IsRecording     :" + this.primaryRecorder.IsRecording + "\n";
            text += "Transmitting    :" + this.primaryRecorder.IsCurrentlyTransmitting + "\n";
            text += "Detected        :" + this.primaryRecorder.VoiceDetector.Detected + "\n";
