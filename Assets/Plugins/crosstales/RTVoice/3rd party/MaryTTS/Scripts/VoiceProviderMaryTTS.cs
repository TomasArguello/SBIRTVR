...
namespace Crosstales.RTVoice.MaryTTS
{
   ...
   //[ExecuteInEditMode]
   public class VoiceProviderMaryTTS : Provider.BaseCustomVoiceProvider
   {
      #region Variables
      ...
      [Tooltip("Input type for MaryTTS (default: MaryTTSType.RAWMARYXML)."), SerializeField] private Model.Enum.MaryTTSType type = Model.Enum.MaryTTSType.RAWMARYXML;
      ...
      public string URL
      {
         ...
         set
         {
            ...
            Speaker.Instance.ReloadProvider(); //TODO disable?
         }
      }
      ...
      public Model.Enum.MaryTTSType Type
      {
         get => type;
         set => type = value;
      }
...
*/
      ...
      private void Awake()
      {
         ...
         type = Model.Enum.MaryTTSType.SSML;
      }
#endif
